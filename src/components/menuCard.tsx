              ...
              <div key={index} className="flex  w-full justify-between p-2 ">
                ...
                <div className="flex justify-center size-44 p-2">
                  <img
                    ...
                    alt="itemImage"
                  />
                  <button className=" border shadow-sm absolute my-36 px-10 py-2 rounded-md text-green-500 font-bold bg-white hover:bg-gray-200">
                    ADD
                  </button>
                </div>
              </div>
            ) : each.itemCards ? (
              each.itemCards.map((each: any, idx: number) => (
